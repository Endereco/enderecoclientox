...
<script type="text/javascript" src="[{$oViewConf->getModuleUrl('enderecoclientox', 'out/endereco-sdk/services/AddressCheck.js')}]?v=1.10.1"></script>
...
<script type="text/javascript" src="[{$oViewConf->getModuleUrl('enderecoclientox', 'out/endereco-sdk/services/PostCodeAutocomplete.js')}]?v=1.5.7"></script>
<script type="text/javascript" src="[{$oViewConf->getModuleUrl('enderecoclientox', 'out/endereco-sdk/services/CityNameAutocomplete.js')}]?v=1.5.6"></script>
