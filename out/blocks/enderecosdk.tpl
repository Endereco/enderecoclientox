...
<script type="text/javascript" src="[{$oViewConf->getModuleUrl('enderecoclientox', 'out/endereco-sdk/services/PostCodeAutocomplete.js')}]?v=1.5.4"></script>
<script type="text/javascript" src="[{$oViewConf->getModuleUrl('enderecoclientox', 'out/endereco-sdk/services/CityNameAutocomplete.js')}]?v=1.5.2"></script>
